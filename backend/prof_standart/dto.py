...
class ParticularWorkFunction:
    sub_qualification: Optional[str]
    other_characteristics: Optional[dict]
    list_footnes: Optional[dict]
...
class GeneralizedWorkFunction:
    level_of_qualification: Optional[str]
    special_conditions_for_admission_to_work: dict
    other_characteristics: Optional[dict]
    ...
    other_characteristic_plus: Optional[dict]
...
@dataclass
class ProfStandarts:
    professional_standart: ProfStandart
